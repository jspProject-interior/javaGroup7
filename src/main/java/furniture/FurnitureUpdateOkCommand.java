...
public class FurnitureUpdateOkCommand implements FurnitureInterface {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int pay = multipartRequest.getParameter("pay") == null || multipartRequest.getParameter("pay").equals("") ? 0 : Integer.parseInt(multipartRequest.getParameter("pay"));
		String saleUnit = multipartRequest.getParameter("saleUnit") == null ? "" : multipartRequest.getParameter("saleUnit");
