...
<body>
	<div style="width: 100%; background-color: #a67d3f; padding: 20px 0;">
		<div class="row">
			<div class="col" style="text-align: left; margin-left: 5%;">
		...
		<div class="row">
			<div class="col text-left text-white" style="margin-left: 5%;">
				<hr style="width: 200%;">
