...
<body oncontextmenu="return false" onselectstart="return false" ondragstart="return false" onkeydownn="return false">
  ...
  <div class="contain">
    ...
    <form name="myform" method="post" enctype="multipart/form-data" action="InteriorUpdateOk.in?idx=${vo.idx}">
      ...
      <div class="form-group">
        ...
        <select class="form-control" id="category" name="category">
          ...
          <option value="MODERN" ${vo.category == 'MODERN' ? 'selected' : ""}>모던</option>
          <option value="NATURAL" ${vo.category == 'NATURAL' ? 'selected' : ""}>네츄럴</option>
          <option value="VINTAGE" ${vo.category == 'VINTAGE' ? 'selected' : ""}>빈티지</option>
			  ...
			  <div>
			    ...
			    <div class="image-upload-container">
			      <label for="image-upload-main" style="width: 100%; height: 100%; display: flex; justify-content: center; align-items: center;">
			        ...
			        <img src="${ctp}/images/interior/upload/${vo.titleImg}" id="image-preview-main" class="image-preview" />
			      </label>
			  ...
			  <div>
			    ...
			    <div class="image-upload-container">
			      <label for="image-upload-detail" style="width: 100%; height: 100%; display: flex; justify-content: center; align-items: center;">
			        ...
			        <img src="${ctp}/images/interior/upload/${vo.subImg}" id="image-preview-detail" class="image-preview"/>
			      </label>
			  ...
			  <div>
			    ...
			    <div class="image-upload-container">
			      <label for="image-upload-thumbnail" style="width: 100%; height: 100%; display: flex; justify-content: center; align-items: center;">
			        ...
			        <img src="${ctp}/images/interior/upload/${vo.thumbnail}" id="image-preview-thumbnail" class="image-preview"/>
			      </label>
      ...
      <!-- 제출 버튼 -->
      <button class="learn-more" type="button" onclick="fCheck()">게시물 수정</button>
